...
public class Game extends Canvas implements Runnable {
	...
	private void tick() {
		// update
		key.update(); // Checks which keys are being pressed
		// Modifier modifies speed based on the status of the character in the screen
		double modifier = 1;
	...
	private void tock() {
		...
		// Rendering the entire screen one pixel at a time #efficiency
